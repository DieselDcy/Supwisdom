...
def TranType(filename, typename):
    ...
    if typename == '.pdf':  # pdf->txt
        ...
        print('警告：\n您输入不合法，本工具支持pdf/doc/docx格式,请输入正确格式。')
        return
    return new_name


if __name__ == '__main__':
    filePath1 = os.path.abspath(r'../dataSet/Corpus/pdf测试/1.pdf')
    filePath2 = os.path.abspath(r'../dataSet/Corpus/pdf测试/2.pdf')
    filePath3 = os.path.abspath(r'..\dataSet\wordtotxt\探寻张孝祥传达“无可奈何”之美的意象世界.docx')
    Files2Txt(filePath3)
